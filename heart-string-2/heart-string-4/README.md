...
- If your left/right hand ever comes out backwards (camera mirroring is
  inconsistent across browsers and hard to get right from code alone),
  tap the **Flip hands** button near the top — it swaps which hand is
  which instantly, no reload needed.
